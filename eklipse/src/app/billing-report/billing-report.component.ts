...
export class BillingReportComponent {
  ...
  listBillReport: BillReport[]=[];

  //@ViewChild(MatPaginator) paginator: MatPaginator;
  //@ViewChild(MatSort) sort: MatSort;

  constructor(private http: HttpClient,
              private billinService: BillingReportService){
    this.getBillingReport()
    //this.dataSource = new MatTableDataSource();
  }

  getBillingReport(){
    this.billinService.getBillingReport().subscribe(res=>{
      this.listBillReport = res.dataResponse;
      console.log(this.listBillReport)
    })
  }
